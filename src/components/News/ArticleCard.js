  ...
  return (
    <div className="mb-6 flex flex-wrap">
      <div className="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
        <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"      ref={ripple}
              onMouseDown={event}> 
          <div>
            <img
              src={imageUrl}
      ...
      <div className="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12 dark:text-white">
        ...
        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
          <small>
            Published <u>{publishedDate}</u> by
            <a href="#!">{author}</a>
          </small>
        </p>
